...
| [brainstorming](skills/brainstorming/SKILL.md) | Creative or implementation work with an unsettled design — explore intent and design and get it approved before writing code; a request that already names the change, its site, and the outcome is its own spec |
