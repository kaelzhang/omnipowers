...
When the user has approved the design and you are about to record it and move to implementation, read `@after-the-design.md` and apply it — it carries where the spec is written, what it MUST NOT contain, the required spec self-review, and the handoff.
